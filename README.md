...
#### Greedy
Code for the greedy algorithm goes here.

#### Branch and Bound
Code for the branch and bound algorithm goes here.

#### States Class
Code for the `States` class goes here.

#### Priority Queue
Code for the priority queue implementation goes here.
